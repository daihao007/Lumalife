...
`07_测试报告.md`、`08_部署文档.md`、`09_用户手册.md`、`12_软件需求规格说明书.md`、`13_概要设计说明书.md`、`14_详细设计说明书.md` 及其六份对应 PDF 已更新为当前微服务验收版。其余阶段文档、软件开发计划书 PDF 以及 `diagrams/d03|d04` 仍主要描述单体/兼容层或历史阶段；相关类仍可用于 `monolith-start` 基线与回滚，但不能据此说明 `prod,remote` 的当前服务调用关系。

## PDF 状态

六份正式 PDF（测试报告、部署文档、用户手册、需求、概要、详细设计）已于 2026-09-03 从当前 Markdown 重新生成，并完成 5/6/12/8/7/8 页逐页视觉检查。用户手册 PDF 为 A4、12/12 页文本非空并嵌入 8/8 张操作截图。软件开发计划书仍为历史导出，因此整体 PDF 交付状态为 **⚠️ 部分完成**，不得把该旧 PDF 当作当前版本。
