...
| --- | --- | --- | --- |
| 测试 | 40、46、59、68、74、78、92 等 | 218 defined；本轮 202 executed / 201 pass / 1 fail | 已建立唯一 Inventory；历史报告加提示，旧执行数字保留 |
...
| E2E 状态 | UI 3/3 历史记录 | 本轮 UI 2/3，1 fail | Inventory/README/审计已校准 |
