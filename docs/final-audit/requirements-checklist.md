...
> 课程基准：《软件工程基础实践》课程任务书（2026 夏季学期），本机外部来源 `软件工程基础实践-2026夏.md`。仓库内没有任务书副本；若授权允许，答辩交付前应纳入 `02_docs`。代码基线：`main@dc96528`。
...
| R07 | E2E 覆盖全部 UC 且当前版本通过 | 测试/用例回归 | ❌ 未完成 | 19 个 E2E 场景 | 本轮 UI 2/3，1 fail；remote 9/9 为旧提交；legacy 7 NOT-RUN | Inventory | 是：修复并重跑 |
