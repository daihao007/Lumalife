...
> 历史单体详细设计：文中对象仍用于 `monolith` 兼容层，但默认生产数据访问由 Remote Port、各服务 Store/JdbcTemplate 和 RabbitMQ Saga 完成。当前类/通信事实见 [`architecture/service-communication.md`](architecture/service-communication.md)；正式提交前须整体改版并重新导出 PDF。
