...
> 审计基线：`monolith-start` 标签，解引用提交 `a1a93529f81ccb3ba1f52b549c8d2027383066e8`（2026-08-25）
...
| POST | `/api/v1/payments` | Authenticated | 幂等模拟支付；同步预占库存，支付提交后仅由 `OrderPaid.v1` 确认库存 |
