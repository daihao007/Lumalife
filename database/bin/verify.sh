...
assert_query 'versioned migrations' '18' "SELECT COUNT(*) FROM schema_migration WHERE version IN ('V001', 'V002', 'V003', 'V004', 'V005', 'V006', 'V007', 'V008', 'V009', 'V010', 'V011', 'V012', 'V013', 'V014', 'V015', 'V016', 'V017', 'V018')"
...
assert_query 'identity service migrations' '18' "SELECT COUNT(*) FROM ${MYSQL_IDENTITY_DATABASE}.schema_migration WHERE version IN ('V001', 'V002', 'V003', 'V004', 'V005', 'V006', 'V007', 'V008', 'V009', 'V010', 'V011', 'V012', 'V013', 'V014', 'V015', 'V016', 'V017', 'V018')"
assert_query 'merchant service migrations' '18' "SELECT COUNT(*) FROM ${MYSQL_MERCHANT_DATABASE}.schema_migration WHERE version IN ('V001', 'V002', 'V003', 'V004', 'V005', 'V006', 'V007', 'V008', 'V009', 'V010', 'V011', 'V012', 'V013', 'V014', 'V015', 'V016', 'V017', 'V018')"
assert_query 'order service migrations' '18' "SELECT COUNT(*) FROM ${MYSQL_ORDER_DATABASE}.schema_migration WHERE version IN ('V001', 'V002', 'V003', 'V004', 'V005', 'V006', 'V007', 'V008', 'V009', 'V010', 'V011', 'V012', 'V013', 'V014', 'V015', 'V016', 'V017', 'V018')"
