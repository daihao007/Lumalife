...
> 最终答辩事实口径（2026-09-03，当前审计基线 `main@bd66765`）：关键数字、验证来源与未完成项统一见 [`docs/project-facts.md`](docs/project-facts.md) 和 [`docs/final-audit/final-project-audit.md`](docs/final-audit/final-project-audit.md)。带日期的阶段报告与旧 PDF 是历史证据，不代表当前 HEAD。
